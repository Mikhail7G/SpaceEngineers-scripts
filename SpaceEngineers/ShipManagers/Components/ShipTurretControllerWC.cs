...
namespace SpaceEngineers.ShipManagers.Components.ControllerWC
{
    public sealed class Program : MyGridProgram
    {
        ...
        public void GetIniData()
        {
            ...
            else
            {
                ...
                designatorTurretTag = dataSystem.Get("TurretRadar", "DesignatorTurretTag").ToString();
                designatorDisplayName = dataSystem.Get("TurretRadar", "DesignatorDisplayName").ToString();
        ...
        public void InitCustomData()
        {
            ...
            if (data.Length == 0)
            {
                ...
                dataSystem.AddSection("TurretRadar");
                dataSystem.Set("TurretRadar", "DesignatorTurretTag", "[d]");
                dataSystem.Set("TurretRadar", "DesignatorDisplayName", "DesRadar");
